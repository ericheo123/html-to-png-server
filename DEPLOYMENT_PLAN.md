...
5. n8n에 `n8n_workflow_instagram_news.json` 을 import 합니다.
6. n8n의 `Prepare Payload` 노드를 실제 뉴스 선택/카드 데이터 생성 노드로 바꿉니다.
7. 수동 1회 실행으로 Instagram 발행을 검증합니다.
