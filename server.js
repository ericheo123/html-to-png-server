...
:root{
  ...
  --W:800px;--H:1000px;
  --fs-hero:132px;--fs-h1:66px;--fs-h2:48px;--fs-h3:32px;
...
.ctitle{font-size:var(--fs-h1);font-weight:900;color:var(--t);line-height:1.16;margin-bottom:28px;word-break:keep-all;letter-spacing:-0.03em}
...
.c1 .hero2{font-size:64px;font-weight:900;color:var(--t);line-height:1.1;margin-bottom:24px;word-break:keep-all}
...
.c1 .sub{font-size:var(--fs-body);color:var(--m);line-height:1.72;margin-bottom:28px;font-weight:500;word-break:keep-all}
...
.si-desc{font-size:var(--fs-small);color:var(--m);margin-top:6px;font-weight:500;word-break:keep-all;line-height:1.55}
.ii{padding:18px 22px;display:flex;gap:14px;align-items:flex-start}
...
.ii-d{font-size:var(--fs-small);color:var(--m);line-height:1.55;font-weight:500;word-break:keep-all}
.ci{padding:22px 26px;display:flex;gap:18px;align-items:flex-start}
...
.ai{padding:20px 24px;display:flex;gap:16px;align-items:flex-start}
...
.c6 .ft{font-size:var(--fs-h1);font-weight:900;color:var(--t);line-height:1.22;margin-bottom:22px;word-break:keep-all}
.c6 .ft em{color:var(--r);font-style:normal}
.c6 .fd{font-size:var(--fs-body);color:var(--m);line-height:1.82;margin-bottom:34px;font-weight:500;word-break:keep-all}
